  ...
  return (
    <>
      <Titles
        ...
        a la carta!"
      />
      <GuitarComponentsList woods={woods} label={"Añadir"} onWoodDeleted={onAddWood} buttonColor={"bg-blue-700 hover:bg-blue-900 text-white font-bold py-2 px-4 rounded"} />
    </>
  );
}
